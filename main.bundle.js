...
module.exports = "<p class=\"logo\">Support<span class=\"text-style-1\">Hub</span></p><br><br>\r\n<div class=\"login-form\">\r\n    <p class=\"text-center\">Sign in with Email</p>       \r\n    <div class=\"form-group\">\r\n        <input [(ngModel)]=\"email\" type=\"text\" class=\"form-control\" placeholder=\"Email\" required=\"required\">\r\n    </div>\r\n    <div class=\"form-group\">\r\n        <input [(ngModel)]=\"passcode\" type=\"password\" class=\"form-control\" placeholder=\"Password\" required=\"required\">\r\n    </div>\r\n    <div class=\"form-group\">\r\n        <button (click)=\"loginUser()\" type=\"button\" class=\"btn btn-primary btn-block\">Sign in</button>\r\n    </div>        \r\n    <p class=\"text-center\">New Here?</p>\r\n    <button (click)=\"redirectToReg('p')\" type=\"button\" class=\"btn btn-primary btn-block\" style=\"white-space: normal\">I am looking for support</button>\r\n    <button (click)=\"redirectToReg('s')\" type=\"button\" class=\"btn btn-primary btn-block\" style=\"white-space: normal\">Become a Support worker</button>\r\n</div>\r\n    "
...
var AppLoginComponent = (function () {
    function AppLoginComponent(router) {
        this.router = router;
    }
...
var RegistrationComponent = (function () {
    function RegistrationComponent(route) {
        this.route = route;
    }
